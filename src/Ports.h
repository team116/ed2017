...
namespace RobotPorts
{
	...
	const unsigned int MOTOR_CLIMBER = 7;
	const unsigned int MOTOR_BLENDER = 8;

	//navX Motors
	const unsigned int SERVO_GEAR_RIGHT = 10;//N0
	const unsigned int SERVO_GEAR_LEFT = 11;//N1
	const unsigned int SERVO_CONVERTER = 12;//N2
